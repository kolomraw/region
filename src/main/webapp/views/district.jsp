...
District edit = (District) request.getAttribute("editDistrict");
%>
...
<td>
<a href="district?editId=<%= d.getId() %>" class="btn btn-sm btn-edit">
...
<td>
<a href="district?deleteId=<%= d.getId() %>" class="btn btn-sm btn-delete">
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor">
...
<h4 class="mb-3"><%= edit != null ? "Редактировать" : "Новый район" %></h4>
